...
public class MainFrame extends JFrame {
    ...
    public MainFrame(Double[] coefficients) {
        ...
        JMenu serviceMenu = new JMenu("Справка");
        menuBar.add(serviceMenu);

        Action aboutProgramAction = new AbstractAction("О программе") {
            @Override
            public void actionPerformed(ActionEvent e) {
                JOptionPane.showMessageDialog(MainFrame.this, "Мария Синьковская\n8 группа", "О программе", JOptionPane.INFORMATION_MESSAGE);
            }
        };
        JMenuItem aboutProgramItem = serviceMenu.add(aboutProgramAction);
    ...
    public static void main(String[] args){
        ...
        MainFrame mainFrame = new MainFrame(coefficients);
